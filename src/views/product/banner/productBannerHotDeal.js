...
function ProductBannerHotDeal() {
  ...
  const handleEditClick = (id) => {
    navigate(`/product/banner-hot-deal?id=${id}&sub=edit`)
  }
    ...
    Array.from(files).forEach((file) => {
      ...
      fileReader.onload = (event) => {
        ...
        if (selectedFiles.length === files.length) {
          setSelectedFileBanner(selectedFiles)
        }
      }
    })

    // Set file URLs for immediate preview
    setFileBanner(fileUrls)
  }
    ...
    <div>
      {!isPermissionCheck ? (
        ...
        <>
          ...
          <CRow className="mb-3">
            <CCol md={6}>
              <h2>BANNER SẢN PHẨM HOT DEAL</h2>
            </CCol>
            <CCol md={6}>
              <div className="d-flex justify-content-end">
                ...
                <Link to={`/product/banner-hot-deal`}>
                    ...
                    <Form>
                      ...
                      <CCol md={12}>
                        <CFormInput
                          ...
                          type="file"
                          id="formFile"
                          label="Ảnh banner danh mục"
                          size="sm"
                          onChange={(e) => onFileChangeBanner(e)}
                        />
                        <br />
                        ...
                        <div>
                          {fileBanner.length == 0 ? (
                            <div>
                              <CImage
                                className="border"
                                src={`${imageBaseUrl}${selectedFileBanner}`}
                                width={300}
                              />
                            </div>
                          ) : (
                            fileBanner.map((item, index) => (
                      ...
                      <CCol md={12}>
                        <label htmlFor="type-select">Loại danh mục</label>
                        <Field
                          ...
                          options={[
                            ...
                            { label: 'Flash-sale', value: 0 },
                            { label: 'Proudct Hot', value: 1 },
                          ]}
                        />
...
export default ProductBannerHotDeal
