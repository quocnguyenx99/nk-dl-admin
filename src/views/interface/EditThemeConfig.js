...
const ThemeBackgroundWatermarkLayer = ({ background, themeCode }) => {
  ...
  const uniqueId = `edit-dash-pattern-${presetKey}`
      ...
      <div className="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom">
        <div>
          ...
          <p className="text-muted small mb-0">
            Quản lý tổng quan, phân bố trang, sắp xếp khối nội dung, màu sắc & lập lịch chiến dịch
          </p>
        </div>
          ...
          <CCard className="h-100 shadow-xs border">
            ...
            <CCardBody className="p-3 d-flex flex-column gap-2 justify-content-center">
              <CButton
                ...
                onClick={() =>
                  toast.info('Tính năng xem trước giao diện đang áp dụng trực tiếp bên dưới!')
                }
              >
