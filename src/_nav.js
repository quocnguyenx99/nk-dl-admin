...
const _nav = [
  { component: CNavTitle, name: 'TỔNG QUAN' },
  {
    component: CNavItem,
  ...
  { component: CNavTitle, name: 'QUẢN TRỊ HỆ THỐNG' },
  {
    component: CNavGroup,
  ...
  },
  {
    ...
    items: [
      { component: CNavItem, name: 'Quản lý thành viên', to: '/member' },
      { component: CNavItem, name: 'Tạo tài khoản website', to: '/member/create' },
    ],
  },
  {
    component: CNavGroup,
  ...
  { component: CNavTitle, name: 'NỘI DUNG & TRUYỀN THÔNG' },
  {
    component: CNavGroup,
  ...
  },
  {
    ...
    icon: <CIcon icon={cilPeople} customClassName="nav-icon" />,
    items: [
      { component: CNavItem, name: 'Quản lý danh mục', to: '/partner/categories' },
      { component: CNavItem, name: 'Quản lý bài đăng', to: '/partner/article' },
      { component: CNavItem, name: 'Thêm mới bài đăng', to: '/partner/article/add' },
    ],
  },
  {
    component: CNavGroup,
  ...
  },
  {
    ...
    items: [
      ...
      { component: CNavItem, name: 'Quản lý video và báo chí', to: '/about/video' },
    ],
  },
  {
    component: CNavGroup,
  ...
  { component: CNavTitle, name: 'CÀI ĐẶT & LIÊN KẾT' },
  {
    component: CNavGroup,
